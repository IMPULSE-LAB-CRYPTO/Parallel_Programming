...
2. **Сложность:** Экспериментально подтверждена теоретическая сложность $O(N^3)$. Как видно на графике, кривая имеет ярко выраженный нелинейный характер. При увеличении размерности $N$ в 2 раза (например, с 800 до 1600), время выполнения увеличилось примерно в 12 раз, что соответствует кубическому росту с учетом влияния подсистемы памяти.
